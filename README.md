...
dotnet run --project src/AssetStore.Cli -- generate-pages --index index.lock.json --out publish/wwwroot --site https://user.github.io/AssetStore --app-index publish/wwwroot/index.html
```
